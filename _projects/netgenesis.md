...
<div class="row justify-content-sm-center"> <div class="col-sm-8 mt-3 mt-md-0"> {% include figure.liquid loading="eager" path="assets/img/netgenesis.png" title="Green university education" class="img-fluid rounded z-depth-1" %} </div> </div>
